              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    ActivityPlanCard(
                      activityPlan: _activityManager.activityPlan,
                      currentActivityId: _activityManager.currentActivity?.id,
                      onRemoveFromPlan: _activityManager.removeFromPlan,
                      onReorderPlan: _activityManager.reorderPlan,
                      onClearPlan: _activityManager.clearPlan,
                    ),
                    const SizedBox(height: 16),
                    ActivitiesCard(
                      ...
                      onAddToPlan: _activityManager.addToPlan,
                    ),
                  ],
                ),
              ),
